...
(async function boot(){
  ...
  <header className="top">
    <a className="name" href="#">Meng To</a>
  </header>
  ...
  <section id="sketchbook" className="hero">
    ...
    <div className="sb-wrap" id="sbWrap">
      ...
      <div className="sb-tools" role="group" aria-label="view controls">
        <button className="tool" id="zOut" aria-label="zoom out"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><circle cx="8.6" cy="8.6" r="5.6"/><path d="M12.8 12.8 17.4 17.4M6.2 8.6h4.8"/></svg></button>
        <span className="zoom-read" id="zRead">100%</span>
        <button className="tool" id="zIn" aria-label="zoom in"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><circle cx="8.6" cy="8.6" r="5.6"/><path d="M12.8 12.8 17.4 17.4M6.2 8.6h4.8M8.6 6.2v4.8"/></svg></button>
        <span className="tool-sep" aria-hidden="true"></span>
        <button className="tool" id="loupeBtn" aria-label="magnifier" aria-pressed="true"><svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><circle cx="8.8" cy="8.8" r="5.8"/><path d="M13 13l4.4 4.4"/><path d="M6.4 7.2a3.2 3.2 0 0 1 2.4-1.4" opacity=".55"/></svg></button>
      </div>
      <p className="sb-hint" id="sbHint">Drag the page to turn · Drag the glass across it</p>
    </div>

    <button className="hero-down" id="heroDown" aria-label="scroll to about">
  ...
  <section id="contact" className="contact">
    ...
    <p className="bio">Write to me at <a className="bio-link" href="mailto:meng@designcode.io">meng@designcode.io</a>. I read everything, and I answer most of it.</p>
    <p className="contact-social">
      <a className="bio-link" href="https://x.com/MengTo" target="_blank" rel="me noopener">X</a>
      <a className="bio-link" href="https://www.linkedin.com/in/mengto" target="_blank" rel="me noopener">LinkedIn</a>
      <a className="bio-link" href="https://www.instagram.com/mengto" target="_blank" rel="me noopener">Instagram</a>
    </p>
  </section>

  <p className="foot">Singapore · Sketchbook</p>
